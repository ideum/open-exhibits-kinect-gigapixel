	...
	<Gesture_set gesture_set_name="n-manipulate">
		...
		<Gesture id="1-finger-drag" type="drag">
				<match>
					<action>
						<initial>
							<cluster point_number="1" point_number_min="1" point_number_max="1" translation_threshold="0"/>
						</initial>
					</action>
				</match>	
				<analysis>
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="drag_dx" target="x" func="linear" factor="0.1" delta_threshold="false" delta_min="0.01" delta_max="100"/>
							<property ref="drag_dy" target="y" func="linear" factor="0.1" delta_threshold="false" delta_min="0.01" delta_max="100"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			...
			<Gesture id="n-scale" type="scale">
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="scale_dsx" target="scaleX" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="1" boundary_max="4"/>
							<property ref="scale_dsy" target="scaleY" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="1" boundary_max="4"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			...
			<Gesture id="2-finger-scale" type="scale">
				<match>
					<action>
						<initial>
							<cluster point_number="2" point_number_min="2" point_number_max="5" separation_threshold="0"/>
						</initial>
					</action>
				</match>
				<analysis>
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="scale_dsx" target="scaleX" func="linear" factor="0.3" delta_threshold="true" delta_min="0.1" delta_max="20" boundaryOn="true" boundary_min="1" boundary_max="4"/>
							<property ref="scale_dsy" target="scaleY" func="linear" factor="0.3" delta_threshold="true" delta_min="0.1" delta_max="20" boundaryOn="true" boundary_min="1" boundary_max="4"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			...
			<Gesture id="4-finger-scale" type="scale">
				<match>
					<action>
						<initial>
							<cluster point_number="4" point_number_min="4" point_number_max="5" separation_threshold="0"/>
						</initial>
					</action>
				</match>
				<analysis>
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="scale_dsx" target="scaleX" func="linear" factor="0.0132" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="1" boundary_max="4"/>
							<property ref="scale_dsy" target="scaleY" func="linear" factor="0.0132" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="1" boundary_max="4"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
